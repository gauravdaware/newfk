...
<body>
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								...
								<div class="col-sm-6">
									<img src="<?php echo base_url();?><?php echo ASSETS_PATH;?><?php echo IMG_PATH;?>home/girl1.jpg" class="girl img-responsive" alt="" />
									<img src="<?php echo base_url();?><?php echo ASSETS_PATH;?><?php echo IMG_PATH;?>home/pricing.png"  class="pricing" alt="" />
								</div>
							</div>
							<div class="item">
								<div class="col-sm-6">
								...
								<div class="col-sm-6">
									<img src="<?php echo base_url();?><?php echo ASSETS_PATH;?><?php echo IMG_PATH;?>home/girl2.jpg" class="girl img-responsive" alt="" />
									<img src="<?php echo base_url();?><?php echo ASSETS_PATH;?><?php echo IMG_PATH;?>home/pricing.png"  class="pricing" alt="" />
								</div>
							</div>
							...
							<div class="item">
								...
								<div class="col-sm-6">
									<img src="<?php echo base_url();?><?php echo ASSETS_PATH;?><?php echo IMG_PATH;?>home/girl3.jpg" class="girl img-responsive" alt="" />
									<img src="<?php echo base_url();?><?php echo ASSETS_PATH;?><?php echo IMG_PATH;?>home/pricing.png" class="pricing" alt="" />
								</div>
							</div>
	...
	<section>
		<div class="container">
			<div class="row">
			<!--Sidebar-->
			<?php $this->view('includes/left_sidebar_view');?>
			<!--/Sidebar-->			
							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											<img src="<?php echo base_url();?>uploads/<?php echo $row->prod_thumb_image;?>" alt="" />
											<h2>Rs.<?php echo $row->prod_sp; ?></h2>
							...
							<div class="tab-pane fade active in" id="tshirt" >
								<div class="col-sm-3">
									<div class="product-image-wrapper">
										<div class="single-products">
											<div class="productinfo text-center">
												<img src="<?php echo base_url();?><?php echo ASSETS_PATH;?><?php echo IMG_PATH;?>home/gallery1.jpg" alt="" />
												<h2>$56</h2>
								...
								<div class="col-sm-3">
									<div class="product-image-wrapper">
										<div class="single-products">
											<div class="productinfo text-center">
												<img src="<?php echo base_url();?><?php echo ASSETS_PATH;?><?php echo IMG_PATH;?>home/gallery2.jpg" alt="" />
												<h2>$56</h2>
												<p>Easy Polo Black Edition</p>
												<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
											</div>
								...
								<div class="col-sm-3">
									<div class="product-image-wrapper">
										<div class="single-products">
											<div class="productinfo text-center">
												<img src="<?php echo base_url();?><?php echo ASSETS_PATH;?><?php echo IMG_PATH;?>home/gallery3.jpg" alt="" />
												<h2>$56</h2>
												<p>Easy Polo Black Edition</p>
												<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
											</div>
								...
								<div class="col-sm-3">
									<div class="product-image-wrapper">
										<div class="single-products">
											<div class="productinfo text-center">
												<img src="<?php echo base_url();?><?php echo ASSETS_PATH;?><?php echo IMG_PATH;?>home/gallery4.jpg" alt="" />
												<h2>$56</h2>
												<p>Easy Polo Black Edition</p>
												<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
											</div>
								...
								<div class="item active">	
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="<?php echo base_url();?><?php echo ASSETS_PATH;?><?php echo IMG_PATH;?>home/recommend1.jpg" alt="" />
													<h2>$56</h2>
													<p>Easy Polo Black Edition</p>
													<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
												</div>
									...
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="<?php echo base_url();?><?php echo ASSETS_PATH;?><?php echo IMG_PATH;?>home/recommend2.jpg" alt="" />
													<h2>$56</h2>
													<p>Easy Polo Black Edition</p>
													<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
												</div>
									...
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="<?php echo base_url();?><?php echo ASSETS_PATH;?><?php echo IMG_PATH;?>home/recommend3.jpg" alt="" />
													<h2>$56</h2>
													<p>Easy Polo Black Edition</p>
													<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
												</div>
