    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./"><img src="<?php echo base_url(); ?><?php echo ADMIN_ASSETS_PATH; ?><?php echo ADMIN_IMG_PATH; ?>logo.png" alt="Logo"></a>
                <a class="navbar-brand hidden" href="./"><img src="<?php echo base_url(); ?><?php echo ADMIN_ASSETS_PATH; ?><?php echo ADMIN_IMG_PATH; ?>logo2.png" alt="Logo"></a>
            </div>
