...
<body>
        ...
        <!-- Left Panel -->
<?php
$this->view('admin/includes/menu_view');
?>
    <!-- Left Panel -->
    ...
    <div id="right-panel" class="right-panel">
        ...
        <!-- Header-->
  <?php
  $this->view('admin/includes/header_view');
  ?>
        <!-- Header-->
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.1.12.3/umd/popper.min.js"></script>
    ...
    <script src="<?php echo base_url(); ?><?php echo ADMIN_ASSETS_PATH; ?><?php echo ADMIN_JS_PATH; ?>lib/chart-Chart.bundle.js"></script>
